...
const fakeData = {
	meta: {
		...
		negative_prompt:
			"Nunc nisl ultrices nisl, eu ultricies nisl nisl eget nisl. Nullam euismod, nisl eget aliquam ultricies, nunc nisl ultrices nisl, eu ultricies nisl nisl eget nisl.",
...
const DataPreview = ({ data }) => {
	...
	return (
		<>
			...
			<div
				className="container grid hover:bg-gray-50 cursor-pointer"
			...
			>
				<div className="grid text-sm w-full divide-y-[0.5px] px-3 divide-gray-300 items-center overflow-y-auto max-h-[26rem]">
					<p className="font-medium w-full px-4 py-3">{metadata.meta.prompt}</p>
					<p className="font-medium w-full px-4 py-3">
						{metadata.meta.negative_prompt}
					</p>
					<p className="font-medium w-full px-4 py-3">{metadata.meta.model}</p>
					<p className="font-medium w-full px-4 py-3">{metadata.meta.vae}</p>
					<p className="font-medium w-full px-4 py-3">
					...
					<p className="font-medium w-full px-4 py-3">{metadata.meta.steps}</p>
					<p className="font-medium w-full px-4 py-3">
						{metadata.meta.guidance_scale}
					</p>
					<p className="font-medium w-full px-4 py-3">{metadata.meta.seed}</p>
					<p className="font-medium w-full px-4 py-3">
