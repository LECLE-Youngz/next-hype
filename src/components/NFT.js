                    ...
                    <div className="my-auto h-[8rem] grid">
                        ...
                        <div className='h-full pb-3 flex justify-between w-full'>
                            <div className='self-center group'>
                                <Link to={"/profile/" + owner.id} className="text-gray-800 group-hover:text-gray-500 flex items-center space-x-2 text-xs">
                                    <img src={owner.picture} className="border h-10 border-gray-200 group-hover:border-gray-900 rounded-none" alt="..." />
