        ...
        <div className='fixed top-0 right-0 z-30 h-screen w-screen flex items-center justify-center bg-gray-900 bg-opacity-50 select-none'>
            <div className="flex items-center justify-center text-gray-500 md:w-8/12 lg:w-6/12 xl:w-4/12">
                <div className="bg-white shadow-xl w-full px-16 py-5">
                    <h3 className="font-extrabold text-4xl text-gray-800 text-center mt-4 mb-10">Edit NFTs' Price</h3>
                    <div class="container mx-auto">
                        <div className="grid space-y-5">
                            ...
                            <div className='flex justify-between items-center'>
                                ...
                                <button className={`${inputClass[price !== 0]} rounded-full border-2 cursor-pointer rounded-l-none h-12 font-semibold w-1/2 flex items-center justify-center`} onClick={() => setPrice(0)} defaultValue={price === 0}>
                                    Not for sale
                                </button>
                            </div>
                        </div>
                        <div className='flex'>
                            <button className={`${onSummit ? "border-gray-500 cursor-default" : "hover:border-gray-500"} group h-12 px-6 mt-10 mx-auto border-2 border-gray-200 rounded-full transition duration-300 w-1/3 disabled:cursor-default disabled:pointer-events-none`} onClick={() => summit()} disabled={price === null || onSummit === onSuccess}>
