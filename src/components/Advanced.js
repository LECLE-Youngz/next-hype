    ...
    return (
        <div className='fixed top-0 right-0 z-30 h-screen w-screen flex items-center justify-center bg-gray-900 bg-opacity-50 select-none'>
            <div className="flex items-center justify-center text-gray-500 md:w-11/12 lg:w-3/4 xl:w-2/5">
                <div className="bg-white shadow-xl w-full p-5">
                    <h3 className="font-extrabold text-4xl text-gray-800 text-center mt-4">Advanced</h3>
                    <div className="py-10 mx-10">
                        ...
                        <div className="mt-10 space-y-2 text-gray-600 text-center sm:-mb-8">
                            <p className="text-xs">Your LINK keys which is associated with this account is shown up here.</p>
                            <p className="text-xs">
