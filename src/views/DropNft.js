    ...
    return (
        <div className="flex flex-col justify-between">
            ...
            <div className="container mx-auto mt-10 flex">
                ...
                {/* 1/4 Buttons */}
                <div className="w-1/4 p-8 flex flex-col mt-auto self-end">
                    <div className="fixed top-40 border-black border rounded p-4 text-center">
                    ...
                    <button
                        className="bg-white border border-gray-900 hover:bg-gray-900 inline-block text-gray-900 hover:text-gray-100 px-5 py-3 h-min self-center text-2xl mt-4"
